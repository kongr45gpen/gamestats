...
class StatsModel extends \Qore\BaseModel implements \Packs\Bzstats\Unreal\iDbStats {
   ...
   /**
    * Returns a list of the servers where the player currently is
    * An empty array is returned when the player is nowhere to be found
    *
    * @param string $playerName
    * @param string $startDate
    * @param string $endDate
   ...
   public function getPlayerCurrentServers($playerName, $startDate, $endDate) {
       return $this->db->getPlayerCurrentServers($playerName, $startDate, $endDate);
   }
